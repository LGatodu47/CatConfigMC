...
You can use this library in your fabric projects by adding its artifacts located at `io.github.lgatodu47.meowrapper`
...
dependencies {
    [...]
    def catConfigMCDependency = "io.github.lgatodu47:catconfig-mc-${mc_version}:0.1.0"
